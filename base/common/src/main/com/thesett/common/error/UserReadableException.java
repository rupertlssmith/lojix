...
/**
 * UserReadableException is an exception class that implements the {@link UserReadableError} interface. It provides a
 * useful base from which to derive application exceptions.
 *
...
public class UserReadableException extends BaseApplicationException implements UserReadableError
{
     ...
     */
    public UserReadableException(String message, Throwable cause, String key, String userMessage)
    {
