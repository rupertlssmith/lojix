 ...
 * <tr><td>Wrap a properties object as parsed properties.
 * <tr><td>Set properties from basic Java types.
 * <tr><td>Extract properties to basic Java types.
 * <tr><td>Allow properties to be set, only if they are not already set.
 * </table></pre>
 *
 * @author Rupert Smith
 */
