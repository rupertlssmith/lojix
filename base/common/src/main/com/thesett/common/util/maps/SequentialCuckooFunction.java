...
public class SequentialCuckooFunction<K> implements SequentialFunction<K>
{
     ...
     * successively applies {@link #hash1(int)} if the generated hash code is not different to the hash code generated by
     * running {@link #hash1(int)} on the key. This ensures that the hash code returned by this will be different to the
     * one generated by {@link #hash1(int)}.
     *
