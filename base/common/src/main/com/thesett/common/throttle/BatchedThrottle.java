 ...
 *
 * <p/>The batching calculation involves taking the log to the base 100 of the desired rate and rounding this to an
 * integer. The batch size is always an exact power of 100 because of the rounding. The rate for an underlying sleep
 * throttle is then chosen appropriately.
 *
