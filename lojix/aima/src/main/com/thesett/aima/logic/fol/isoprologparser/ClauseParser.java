...
/**
 * Parses first order logic Horn clauses from strings using Prolog syntax.
 *
 ...
 * @author Rupert Smith
 */
public class ClauseParser extends BasePrologParser<Clause>
{
    /**
     ...
     */
    public ClauseParser(VariableAndFunctorInterner interner)
    {
        super(interner);
    }
    ...
    {
        return new SentenceImpl<Clause>(parser.clause());
    }
}
