...
public class WrappedBeanStateTest extends TestCase
{
    ...
    public static Test suite()
    {
        ...
        suite.addTest(new StateTestBase("testGetterMethodExceptionsCausesFailure",
                new WrappedBeanState(new TestBeanImpl())));
        ...
        suite.addTest(new StateTestBase("testSetterMethodExceptionCausesFailure",
                new WrappedBeanState(new TestBeanImpl())));
