 ...
 * @author Rupert Smith
 */
public class InternalMemeoryLayoutBean extends WAMMemoryLayout implements RegisterModel
{
     ...
     */
    public InternalMemeoryLayoutBean(int regBase, int regSize, int heapBase, int heapSize, int stackBase, int stackSize,
