...
/**
 * L3CompiledClause is a clause, that belongs to an {@link L3CompiledPredicate}. Compiled instructions added to the
 ...
 * @author Rupert Smith
 */
public class L3CompiledClause extends Clause<Functor>
{
    /** The parent predicate to which this compiled clause belongs. */
    private final L3CompiledPredicate parent;
     ...
     */
    public L3CompiledClause(L3CompiledPredicate parent)
    {
        super(null, null);
        this.parent = parent;
    }
     ...
     */
    private void addInstructionsAndThisToParent(SizeableList<L3Instruction> instructions)
    {
        if (!addedToParent)
        {
