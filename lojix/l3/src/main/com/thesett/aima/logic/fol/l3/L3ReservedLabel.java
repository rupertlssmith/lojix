...
/**
 * L3ReservedLabel is an {@link L3CallPoint} that is an address for a label. The label in question may be forward
 ...
 * the dummy values can be re-visited and corrected. L3ReservedLabel is an L3CallPoint that also maintains a list of
 * referenced from address to be corrected, once the label address is known.
 *
 * <p/>An L3ReservedLabel is created with an entry point of -1, which means that it has not been resolved to a known
 ...
 * @author Rupert Smith
 */
public class L3ReservedLabel extends L3CallPoint
{
     ...
     */
    public L3ReservedLabel(int functorName)
    {
