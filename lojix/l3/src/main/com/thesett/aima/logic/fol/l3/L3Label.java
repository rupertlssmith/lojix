...
/**
 * L3Label is a code label within a predicate.
 *
 ...
 * @author Rupert Smith
 */
public class L3Label extends FunctorName
{
     ...
     */
    public L3Label(FunctorName parent, int id)
    {
    ...
    {
        return "L3Label: [ name = " + name + ", arity = " + arity + ", id = " + id + " ]";
    }
}
