...
/**
 * L3CallPoint holds the fields recorded against a predicate name in the call table of an {@link L3Machine}. These
...
public class L3CallPoint
{
     ...
     */
    public L3CallPoint(int entryPoint, int length, int functorName)
    {
