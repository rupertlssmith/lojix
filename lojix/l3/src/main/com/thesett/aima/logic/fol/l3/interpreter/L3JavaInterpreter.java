...
import com.thesett.aima.logic.fol.l3.L3ResolvingJavaMachine;
 ...
 * {@link L3ResolvingJavaMachine}.
 *
 * <pre><p/><table id="crc"><caption>CRC Card</caption>
 * <tr><th> Responsibilities <th> Collaborations
 * <tr><td> Create an interpreter for L3.
 *     <td> {@link SentenceParser}, {@link L3Compiler}, {@link L3ResolvingJavaMachine}
 * </table></pre>
 *
 * @author Rupert Smith
 */
public class L3JavaInterpreter
{
    /** Used for debugging purposes. */
    /* private static final Logger log = Logger.getLogger(L3JavaInterpreter.class.getName()); */
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            final L3ResolvingMachine machine = new L3ResolvingJavaMachine(symbolTable);
