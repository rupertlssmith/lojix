...
/**
 * L1CallTableEntry holds the fields recorded against a predicate name in the call table of an {@link L1Machine}. These
...
public class L1CallTableEntry
{
     ...
     */
    public L1CallTableEntry(int entryPoint, int length, int functorName)
    {
