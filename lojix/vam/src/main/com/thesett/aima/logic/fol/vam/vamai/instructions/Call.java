 ...
 * @author Rupert Smith
 */
public class Call extends VAMAIInstruction
{
    /** Creates a VAM AI instruction. */
    public Call()
    {
        super(VAMAIInstructionSet.Call);
    }

    /** {@inheritDoc} */
    public void accept(Visitor<VAMAIInstruction> visitor)
    {
        if (visitor instanceof CallVisitor)
        {
            ((CallVisitor) visitor).visit(this);
        }
        else
        {
