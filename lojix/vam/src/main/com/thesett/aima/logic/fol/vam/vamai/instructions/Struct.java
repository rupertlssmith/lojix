 ...
 * @author Rupert Smith
 */
public class Struct extends VAMAIInstruction
{
    /** Holds the interned name of the functor. */
    private int arg;
    ...
    {
        super(VAMAIInstructionSet.Struct);
    ...
    /**
     * Provides the interned name of the functor.
     *
     * @return The interned name of the functor.
     */
    public int getArg()
    {
        return arg;
