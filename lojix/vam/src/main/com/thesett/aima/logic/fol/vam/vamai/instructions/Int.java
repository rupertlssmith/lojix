 ...
 * @author Rupert Smith
 */
public class Int extends VAMAIInstruction
{
    /** The value of the integer. */
    private int arg;

    /**
     * Creates a VAM AI instruction with the specified argument value.
     *
     * @param value The argument value.
     */
    public Int(int value)
    {
        super(VAMAIInstructionSet.Int);
    ...
    {
        if (visitor instanceof IntVisitor)
        {
            ((IntVisitor) visitor).visit(this);
        }
        else
        {
    ...
    /**
     * Provides the value of the integer argument.
     *
