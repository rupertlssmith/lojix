 ...
 * @author Rupert Smith
 */
public class Const extends VAM2PInstruction
{
    /**
     * Creates a VAM2P instruction with the specified argument.
     *
     * @param value The value of the atom or integer argument.
     */
    public Const(int value)
    {
        super(VAM2PInstructionSet.Const);
    }

    /** {@inheritDoc} */
    public void accept(Visitor<VAM2PInstruction> visitor)
    {
        if (visitor instanceof ConstVisitor)
        {
            ((ConstVisitor) visitor).visit(this);
        }
        else
        {
