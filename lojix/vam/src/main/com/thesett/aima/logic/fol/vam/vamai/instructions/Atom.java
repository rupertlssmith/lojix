 ...
 * @author Rupert Smith
 */
public class Atom extends VAMAIInstruction
{
    /** Holds the interned name of the argument. */
    private int arg;
    ...
    {
        super(VAMAIInstructionSet.Atom);
    ...
    {
        if (visitor instanceof AtomVisitor)
        {
            ((AtomVisitor) visitor).visit(this);
        }
        else
        {
    ...
    /**
     * Provides the interned name of the argument.
     *
     * @return The interned name of the argument.
     */
    public int getArg()
    {
        return arg;
