 ...
 * @author Rupert Smith
 */
public class FirstVar extends VAMAIInstruction
{
     ...
     */
    public FirstVar(int var, byte type, short refChainLength, boolean aliased, boolean aliasable)
    {
        super(VAMAIInstructionSet.FirstVar);
    ...
    {
        if (visitor instanceof FirstVarVisitor)
        {
            ((FirstVarVisitor) visitor).visit(this);
        }
        else
        {
