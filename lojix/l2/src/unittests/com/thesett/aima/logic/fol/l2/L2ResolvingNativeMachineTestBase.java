 ...
 * @author Rupert Smith
 */
public class L2ResolvingNativeMachineTestBase extends TestCase
{
    /** Holds the L2 machine to run the tests through. */
    private static L2ResolvingMachine machine;

    /** Used for debugging. */
    java.util.logging.Logger log = java.util.logging.Logger.getLogger(L2ResolvingJavaMachineTest.class.getName());
     ...
     */
    public L2ResolvingNativeMachineTestBase(String name)
    {
        super(name);
    }
