 ...
 * {@link L2ResolvingJavaMachine}.
 *
 * <pre><p/><table id="crc"><caption>CRC Card</caption>
 * <tr><th> Responsibilities <th> Collaborations
 * <tr><td> Create an interpreter for L2.
 *     <td> {@link SentenceParser}, {@link L2Compiler}, {@link L2ResolvingJavaMachine}
 * </table></pre>
 *
 * @author Rupert Smith
 */
public class L2JavaInterpreter
{
    /** Used for debugging purposes. */
    /* private static final Logger log = Logger.getLogger(L2JavaInterpreter.class.getName()); */
    ...
    public static void main(String[] args)
    {
        try
        {
            final L2ResolvingMachine machine = new L2ResolvingJavaMachine();
