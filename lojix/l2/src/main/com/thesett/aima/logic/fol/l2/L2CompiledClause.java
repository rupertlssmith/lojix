 ...
 */
public class L2CompiledClause extends Clause<Functor> implements Sentence<L2CompiledClause>, Sizeable
{
    /** Used for debugging. */
    /* private static final Logger log = Logger.getLogger(L2CompiledClause.class.getName()); */
    ...
    /**
     * Creates an empty (invalid) compiled program sentence in L2. The variables of the program senetence are not
     * recorded, since they only need to be tracked in order to display the results of queries.
     */
    public L2CompiledClause()
    {
        super(null, null);
    }

    /**
     * Creates an empty (invalid) compiled query sentence in L2.
     *
     ...
     */
    public L2CompiledClause(Map<Byte, Integer> varNames, Set<Integer> freeVarNames)
    {
        super(null, null);
     ...
     */
    public void setHead(Functor head, SizeableList<L2Instruction> instructions)
    {
        this.head = head;
    ...
    /**
     * Gets the wrapped sentence in the logical language over L2CompiledClauses.
     *
     * @return The wrapped sentence in the logical language.
     */
    public L2CompiledClause getT()
    {
        return this;
    }
     ...
     */
    protected void emmitCode(int offset, byte[] buffer, L2Machine machine, L2CallPoint callPoint)
