...
/**
 * ByteCodePrinter prints the byte code for each compiled clause, aligned with the predicate calls and arguments leading
 * to its generation.
 *
 * <pre><p/><table id="crc"><caption>CRC Card</caption>
 * <tr><th> Responsibilities <th> Collaborations
 * <tr><td> Print the compiled byte code aligned to the source.
 * </table></pre>
 *
 * @author Rupert Smith
 */
