 ...
 * @author Rupert Smith
 */
public class LessThan extends BinaryArithmeticComparison
{
    /**
     * Creates a less-than built-in to implement the specified functor.
     *
     * @param functor The functor to implement as a built in.
     */
    public LessThan(Functor functor)
    {
        super(functor);
    }
