...
/**
 * Minus implements the subtraction operator '-' in Prolog.
 *
 * <pre><p/><table id="crc"><caption>CRC Card</caption>
 * <tr><th> Responsibilities <th> Collaborations
 * <tr><td> Subtract two numeric values together using integer or floating point arithmetic.
 *     <td> {@link NumericType}.
 * </table></pre>
 *
 * @author Rupert Smith
 */
public class Minus extends BinaryArithmeticOperator
{
    /**
     ...
     */
    public Minus(int name, Term[] arguments)
    {
