...
/**
 * Multiply implements the multiplication operator '*' in Prolog.
 *
 * <pre><p/><table id="crc"><caption>CRC Card</caption>
 * <tr><th> Responsibilities <th> Collaborations
 * <tr><td> Multiply two numeric values together using integer or floating point arithmetic.
 *     <td> {@link NumericType}.
 * </table></pre>
 *
 * @author Rupert Smith
 */
public class Multiply extends BinaryArithmeticOperator
{
    /**
     ...
     */
    public Multiply(int name, Term[] arguments)
    {
