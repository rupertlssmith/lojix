...
/**
 * Minus implements the division operator '/' in Prolog.
 *
 * <pre><p/><table id="crc"><caption>CRC Card</caption>
 * <tr><th> Responsibilities <th> Collaborations
 * <tr><td> Divide two numeric values using integer or floating point arithmetic.
 *     <td> {@link NumericType}.
 * </table></pre>
 *
 * @author Rupert Smith
...
public class Divide extends BinaryArithmeticOperator
{
     ...
     */
    public Divide(int name, Term[] arguments)
    {
