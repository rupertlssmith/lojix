...
public interface Traversable<O> extends State
{
     ...
     */
    Traversable<O> getChildStateForOperator(Operator<O> op);
     ...
     */
    Iterator<Operator<O>> validOperators(boolean reverse);
     ...
     *         state.
     */
    Iterator<Successor<O>> successors(boolean reverse);
     ...
     *         null</tt>.
     */
    UnaryPredicate getDefaultGoalPredicate();
}
